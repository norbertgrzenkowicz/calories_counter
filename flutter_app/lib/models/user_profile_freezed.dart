...
class UserProfileFreezed with _$UserProfileFreezed {
  ...
  const factory UserProfileFreezed({
    ...
    @Default('maintaining')
    String goal, // 'weight_loss', 'weight_gain', 'maintaining', 'hypertrophy'
  ...
  factory UserProfileFreezed.fromSupabase(Map<String, dynamic> data) {
    return UserProfileFreezed(
      ...
      weeklyWeightLossTarget:
          _safeParseDouble(data['weekly_weight_loss_target']) == 0.0
              ? 0.5
  ...
  int calculateTargetCalories() {
    ...
    switch (goal) {
      case 'weight_loss':
        ...
        final dailyDeficit =
            weeklyWeightLossTarget * 7700 / 7; // 7700 cal/kg fat
